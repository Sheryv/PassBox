...
public class PassCryptApp extends Application
{
    ...
    public static final String namePath = "/data/passcrypt/data.txt";
    ...
    public static ArrayList<GroupItems> readFile(Activity con)
    {
        ...
        catch (Exception e)
        {
            ...
            showDialog(con.getString(R.string.data_altered), R.string.got, R.string.d_try_again, R.string.d_info, true, "Password | Hash wrong [ID:2]=> " + e.getMessage(), con, null);
            de(e);
            return null;
        }
        ArrayList<GroupItems> groupItemses = fromJson(dec, con);
    ...
    private static ArrayList<GroupItems> fromJson(String txt,Activity con)
    {
      ...
      //  d("dec json: "+txt);
        ...
        catch (JsonSyntaxException e)
        {
           // msgl("Could not load data, incorrect format: " + e.getMessage());
            showDialog(con.getString(R.string.data_altered), R.string.got, R.string.d_try_again, R.string.d_info, true, "Format [ID:3]=> " + e.getMessage(), con, null);
            de(e);
            return null;
        }
        return p;
...
/*        String m = String.valueOf(cal.get(Calendar.MINUTE));
    ...
    public static void showDialog(String txt, int btnT,int btn2T, int titleT, boolean areBtnVisible, String error, final Activity con, final Method m)
    {
        ...
        t.setText(con.getString(R.string.error_details)+error);
